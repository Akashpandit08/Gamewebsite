    ...
    <div class="container">
        ...
        <div  class="conercut">
            <div class="product-detail-div">
                ...
                <div class="leauge">
                    <div>
                            <h1 class="product-name">LEAGUE OF </h1>
    ...
    <section class="game-section">
        <div class="player-game">
            <div  class="game-div">
                ...
                <h3 class="game-name">The Rogue Assassin</h3>
                <div class="play-now">
                            <?php                       
                            $button = new Button();
        ...
        <div class="player-game">
            ...
            <div  class="game-div">
                ...
                <h3 class="game-name">The Chain Warden</h3>
                <div class="play-now">
                    <?php                       
                    $button = new Button();
                    echo $button->render("Play Now");?>
        ...
        <div class="player-game">
            <div  class="game-div">
                ...
                <h3 class="game-name">The Loose Cannon</h3>
                <div class="play-now">
                            <?php                       
                            $button = new Button();
                            echo $button->render("Play Now");?>
        ...
        <div class="player-game">
            ...
            <div  class="game-div">
                ...
                <h3 class="game-name">The Unforgiven</h3>
                <div class="play-now">
                    <?php                       
                    $button = new Button();
                    echo $button->render("Play Now");?>
