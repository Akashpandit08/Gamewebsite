                ...
                <div class="filter-Categories">
                    ...
                    <?php
                        foreach ($categorys as $category) {
                            echo '<input type="checkbox" class="box categoryCheckbox" onclick="checkBoxChange()" name="category" value="' . $category . '" id="' . $category . '">';
            ...
            <div class="sortby">
                ...
                <?php
                       foreach ($productList as $product) {
                        ...
                        ?>
                        <a href="product?product_id=<?php echo $product['product_id'] ?>" class="product-details-item">
                            <?php
    ...
    <section>
        ...
        <script>
            function checkBoxChange(){
                ...
                $.post("getProductsByCategories.php", {'checkedCheckboxes':checkedCheckboxes} )
                    .done(function(data, status) {
                        // var productsData = JSON.parse(data); 
                        $('.product-page').html(data);
                        // console.log("Data: " + productsData[0]['product_name']);
                    })
